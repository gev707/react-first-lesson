...
import  './TextClass/TextClass';
import Show from './TextClass/TextClass';
...
function App() {
  ...
  const slider = {
    imgUrl:'https://cdn130.picsart.com/318787721404201.jpg?type=webp&to=min&r=640',
    imgAlt:'Bird3'
  }
  const slider2 = {
    imgUrl:'https://cdn65.picsart.com/191777528003201.jpg?type=webp&to=min&r=640',
    imgAlt:'Bird3'
  }
  const slider3 = {
    imgUrl:'https://cdn130.picsart.com/322663180511201.jpg?type=webp&to=min&r=640',
    imgAlt:'Bird3'
  }
  return (
    <div className='App'>
